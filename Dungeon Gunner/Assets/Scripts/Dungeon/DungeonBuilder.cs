...
public class DungeonBuilder : SingletonMonoBehaviour<DungeonBuilder>
{
    ...
    protected override void Awake() //singleton classtan inherite ettiðimiz için awake fonksiyonunu da proc override etmemiz lazým ki inherite edilen classlarýn awakeleri deðiþkenlik saðlayabilsin.
    {
        base.Awake();

        LoadRoomNodeTypeList();

        GameResources.Instance.dimmedMaterial.SetFloat("Alpha_Slider", 1f); //hazýrladýgýmýz shaderý kullanacak.
    }
